...
public class SedimentationPlant extends PoweredBuilding {
	 ...
	 * @param level
	 */
	public SedimentationPlant(int health, int level) {
		...
		recipeBook.add(new Recipe(new Item[] {new ConoreSlurry(1)}, new Item[] {new MixedConore(1)}));
		recipeBook.add(new Recipe(new Item[] {new KannaiteSlurry(1)}, new Item[] {new MixedKannaite(1)}));
