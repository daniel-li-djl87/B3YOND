...
/**
 * BucketWheelExcavator.java
 * @author Aaron Ng
 * @date Jan 10, 2018
 * Mining drill that mines ores incredibly fast
 */
public class BucketWheelExcavator extends PoweredBuilding {
	...
	public BucketWheelExcavator(int health, int level,ArrayList<Item> ores) {
	...
	public BucketWheelExcavator(int health, int level) {
		super(health, level,new Dimension(2,2),0,3);
		this.setDim(new Dimension(2,2));
		this.inputInventory=new Item[3];
		this.outputInventory=new Item[3];
		setTimeSinceExtract(System.nanoTime());  
	}
