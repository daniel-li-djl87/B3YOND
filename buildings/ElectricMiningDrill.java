 ...
 * Electric Mining Drill is used to mine from ores
 *
 */
public class ElectricMiningDrill extends PoweredBuilding {
	...
	public ElectricMiningDrill(int health, int level,ArrayList<Item> ores) {
		...
		this.inputInventory = new Item[0];
		this.outputInventory=new Item[3];
		setTimeSinceExtract(System.nanoTime());  
	}
	
	public ElectricMiningDrill(int health, int level) {
		super(health, level,new Dimension(2,2),0,3);
		this.setDim(new Dimension(2,2));
		this.inputInventory = new Item[0];
		this.outputInventory=new Item[3];
