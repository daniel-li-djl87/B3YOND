 ...
 * LowTierBattery stores a minimal amount of energy
 */
...
public class LowTierBattery extends PoweredBuilding {
	...
	/**
	 * LowTierBattery
	 * Constructor for LowTierBattery
	 * @param health, level
	 * @return nothing
	 */
	public LowTierBattery(int health, int level) {
	...
	public  void update() {
		...
		if(getPower()) { //Checks to see if battery is getting charged from somewhere
			...
			if(getCapacity()>60000) {
				setCapacity(60000);    //Maximum capacity
			}
