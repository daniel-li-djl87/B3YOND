 ...
 * @date Dec 18, 2017
 * Geothermal Well takes water deep into the earth where it converts to steam
 */
public class GeothermalWell extends PoweredBuilding {
	...
	/**
	 * GeothermalWell
	 * Constructor for GeothermalWell
	 * @param health
	 * @param level
	 */
	public GeothermalWell(int health, int level) {
		super(health, level, new Dimension(2,2),1,1);
		...
		recipeBook.add(new Recipe(new Item[] {new Water(2)}, new Item[] {new Steam(8)}));
