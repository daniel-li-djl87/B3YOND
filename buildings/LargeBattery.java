 ...
 * LargeBattery object of the game used to store energy
 */
...
public class LargeBattery extends PoweredBuilding {
	 ...
	 * @return nothing
	 */
	public LargeBattery(int health, int level) {
	...
	public  void update() {
		...
		if(getPower()) { //Checks to see if battery is getting charged from somewhere
			...
			if(getCapacity()>300000) {
				setCapacity(300000);    //Maximum capacity
			}
