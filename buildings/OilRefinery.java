...
public class OilRefinery extends PoweredBuilding {
	...
	public OilRefinery(int health, int level) {
		...
		recipeBook.add(new Recipe(new Item[] {new Oil(10)}, new Item[] {new Sulphur(1), new Plastic(2), new Petroleum(5)}));
