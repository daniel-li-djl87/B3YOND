 ...
 * @date Dec 18, 2017
 * Casting Machine casts molten metal into respective metal ingots
 */
public class CastingMachine extends PoweredBuilding {
	...
	/**
	 * CastingMachine
	 * Constructor for CastingMachine
	 * @param health
	 * @param level
	 */
	public CastingMachine(int health, int level) {
		...
		recipeBook.add(new Recipe(new Item[] {new MoltenIron(4)}, new Item[] {new Iron(2)}));
		recipeBook.add(new Recipe(new Item[] {new MoltenCopper(4)}, new Item[] {new Copper(2)}));
		recipeBook.add(new Recipe(new Item[] {new MoltenNickel(4)}, new Item[] {new Nickel(2)}));
		recipeBook.add(new Recipe(new Item[] {new MoltenAluminum(4)}, new Item[] {new Aluminum(2)}));
	...
	public class Smelting implements Runnable{
		...
		public void run() {
			...
			while(getPower() && (inputInventory[0] != null)) { //Only smelt if the furnace has power left
