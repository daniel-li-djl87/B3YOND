 ...
 * @date Dec 16, 2017
 * Leaching Plant takes crushed Conore / Kannaite their respective slurry 
 */
public class LeachingPlant extends PoweredBuilding {
	 ...
	 * @param level
	 */
	public LeachingPlant(int health, int level) {
		super(health, level, new Dimension(3,3),1,1);
		...
		recipeBook.add(new Recipe(new Item[] {new CrushedConore(1)}, new Item[] {new ConoreSlurry(1)}));
		recipeBook.add(new Recipe(new Item[] {new CrushedKannaite(1)}, new Item[] {new KannaiteSlurry(1)}));
