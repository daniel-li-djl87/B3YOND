 ...
 * @author Aaron Ng
 * @date Jan 10, 2018
 * Power Line used to greatly extend range of power
 */
public class LargePowerLine extends PoweredBuilding {
	 ...
	 * @return none
	 */
	public LargePowerLine(int health, int level) {
		super(health, level,new Dimension(1,2),0,0);
		this.setDim(new Dimension(1,2));
	}//end of constructor
